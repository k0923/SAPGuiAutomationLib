...
namespace SAPLibTools
{
    public class CodeGenerateHelper
    {
        ...
        public CodeMemberMethod[] GetFindDescendantsByPropertyMethods()
        {
            string methodName = "FindDescendantsByProperty";
            ...
            for (int i = 0; i < interfaces.Count(); i++)
            {
                ...
                methods[i].Statements.Add(new CodeMethodReturnStatement(
                        new CodeMethodInvokeExpression(
                            new CodeMethodReferenceExpression(null, "findDescendantsByPropertyTemplate", new CodeTypeReference("T")),
